    ...
    <header
      className={`fixed w-full z-50 transition-all duration-300 ${
        scrolled
          ...
          : "bg-background/80 backdrop-blur-sm py-4 border-b border-slate-800"
      }`}
    >
                ...
                >
                  <button
                    className={`w-full text-left px-4 py-2 hover:bg-slate-700 ${
                      i18n.language === "en" ? "text-primary" : "text-slate-300"
                    }`}
                  ...
                  <button
                    className={`w-full text-left px-4 py-2 hover:bg-slate-700 ${
                      i18n.language === "vi" ? "text-primary" : "text-slate-300"
                    }`}
